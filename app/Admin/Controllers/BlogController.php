...
class BlogController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->blogtranslations('Title')->display(function($translations){
    ...
    protected function detail($id)
    {
        ...
        $show->blogtranslations('Translations', function ($translation) {
            $translation->locale();
            $translation->title();
    ...
    protected function form()
    {
        ...
        $form->date('date', __('Date'))->rules('nullable')->help('Optional');
        $form->image('image',__('Image'))->uniqueName()->creationRules('required|max:10240|mimes:jpg,png,jpeg')->updateRules('nullable|max:10240|mimes:jpg,png,jpeg')->help('Requried <br/><i class="fa fa-info-circle"></i> Max Size:10 M <br/><i class="fa fa-info-circle"></i> Ext: jpg, png, jpeg <br/><i class="fa fa-info-circle"></i> Width x Hight :255x215');
        ...
        $form->hasMany('blogtranslations','Translations', function (Form\NestedForm $form) {
