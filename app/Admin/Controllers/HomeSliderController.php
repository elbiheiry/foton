...
class HomeSliderController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->homeslidertranslations('Title')->display(function($translations){
    ...
    protected function detail($id)
    {
        ...
        $show->homeslidertranslations('Translations', function ($translation) {
            $translation->locale();
            $translation->title();
    ...
    protected function form()
    {
        ...
        $form->hasMany('homeslidertranslations','Translations', function (Form\NestedForm $form) {
